        ...
        <div class="col-12 col-md-4">
          <div class="qmi-home">
            ...
            <?php echo get_field('qmi_square_footage') . ' sq ft | ' . get_field('qmi_bedrooms') . ' beds | ' . get_field('qmi_bathrooms') . ' bath<br/>' .
						...
						<a class="builder-btn ltgreen-btn lightbox-trigger base-contact qmi-trigger" data-comm="<?php echo $_projectID ?>" data-model="<?php echo strtolower(get_field('qmi_floorplan')) ?>">Contact Us</a>
          </div>
        </div>
        <?php endwhile; ?>
      </div>
