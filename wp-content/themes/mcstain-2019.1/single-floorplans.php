      ...
      <div class="row">
        <div class="col-12 col-md-4">
          <div class="floorplan-left">
            ...
            <?php if($_cat == 'Painted Prairie'):
              $_postName = $post->post_name;
              $_modelNumber = substr($_postName, -4);
            ?>
            <p>
              <a href="/communities/painted-prairie/floorplan-configurator/#/project/paintedprairie-<?php echo $_modelNumber ?>" class="btn green-btn configurator-btn" target="_blank">
