...
function wpgmaps_tag_pro( $atts ) {
    ...
    if ($infoWindowType >= 1) {
    	...
    	$iw_custom_styles .=  "$mapCSSSelector .wpgmza_modern_infowindow { background-color: " . (!empty($map_other_settings['iw_primary_color']) ? "#" . $map_other_settings['iw_primary_color'] : "#2A3744") . "; }";
    	
    	if($infoWindowType !== 1){
    		$iw_custom_styles .=  "$mapCSSSelector .wpgmza_iw_title { color: " . (!empty($map_other_settings['iw_text_color']) ? "#" . $map_other_settings['iw_text_color'] : "#ffffff") . "; }";
    	} else{
    		$iw_custom_styles .=  "$mapCSSSelector .wpgmza_iw_title { ";
    		$iw_custom_styles .=  "		color: " . (!empty($map_other_settings['iw_text_color']) ? "#" . $map_other_settings['iw_text_color'] : "#ffffff") . "; " ;
    		$iw_custom_styles .=  "		background-color: " . (!empty($map_other_settings['iw_accent_color']) ? "#" . $map_other_settings['iw_accent_color'] : "#252F3A") . ";";
    		$iw_custom_styles .=  " }";
    	}

    	$iw_custom_styles .=  "$mapCSSSelector .wpgmza_iw_description { color: " . (!empty($map_other_settings['iw_text_color']) ? "#" . $map_other_settings['iw_text_color'] : "#ffffff") . "; }";
    	$iw_custom_styles .=  "$mapCSSSelector .wpgmza_iw_address_p { color: " . (!empty($map_other_settings['iw_text_color']) ? "#" . $map_other_settings['iw_text_color'] : "#ffffff") . "; }";
