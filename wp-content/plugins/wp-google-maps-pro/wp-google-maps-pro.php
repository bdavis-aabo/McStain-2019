 ...
 * 5.77 - 2019-02-28 - Medium Priority5.76
 * Fixed notice when saving settings with Pro >= 7.11.00
 * Fixed core.js not correctly enqueued when using a non-standard directory name
 * Fixed can't uncheck checkboxes in global settings where running basic >= 7.11.00
 *
 * 5.76 - 2019-02-01 - Medium Priority
 * Fixed global settings checkboxes not being saved when running basic >= 7.11.00
 *
 * 5.75 - 2018-08-16 - Medium Priority
 * Added CSS fix following recent Google UI changes
 *
 * 5.74 - 2018-07-25 - Medium Priority
 * Fixed apostrophes in translation strings creating JavaScript syntax errors
 * 
...
function wpgmaps_head_pro() {
    ...
    if (isset($_POST['wpgmza_savemap'])){
		...
		if($wpgmza && method_exists($wpgmza, 'getBasicVersion') && version_compare($wpgmza->getBasicVersion(), '7.11.00', '>='))
		{
			$checkboxes = array(
